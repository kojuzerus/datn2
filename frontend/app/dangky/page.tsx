...
>>>>>>> c61f76a (Thêm chức năng vòng quay voucher)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!/^[0-9]{9,11}$/.test(form.soDienThoai.trim()))
      return setError("Số điện thoại phải là số, từ 9-11 chữ số");
...
>>>>>>> c61f76a (Thêm chức năng vòng quay voucher)
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm text-black mb-1">Ngày sinh</label>
              <input
                name="ngaySinh"
                type="date"
                value={form.ngaySinh}
            ...
            <div>
              ...
              {form.email && (
                <p className="text-xs text-green-600 mt-1">
                  ✓ Hóa đơn VAT sẽ gửi qua email này
                </p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm text-black mb-1">Mật khẩu</label>
              <div className="relative">
                <input
                  name="matKhau"
