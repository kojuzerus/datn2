...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-9 right-28 z-40 w-10 h-10 flex items-center justify-center rounded-full bg-red-500 hover:bg-red-600 text-white shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5"
      title="Lên đầu trang"
    >
