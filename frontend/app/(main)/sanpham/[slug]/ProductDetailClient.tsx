...
/* ── Page (Client Component) ───────────────────────────────────────────────
   Toàn bộ nội dung/logic gốc của trang, không đổi gì — chỉ đổi tên export.
   Được render bởi page.tsx (Server Component) để trang vẫn dùng
   generateMetadata() được (Client Component không export được hàm này). ── */
